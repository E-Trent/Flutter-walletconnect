...
//            }
            if(call.method == "walletConnect"){
                ...
                wc.customRequests(jsonStr:"{\"method\": \"personal_sign\",\"params\": [\"0x49206861766520313030e282ac\",\"0x2eB535d54382eA5CED9183899916A9d39e093877\"]}")
                wc.walleConnectFun()
...
//
//    ///链接钱包
//    func walleConnectFun(connectionUrl:String){
